...
new #[Layout('layouts.app')] class extends Component
{
    ...
    {
        return (new UpdateCustomerRequest)->rules($this->customer->id);
    }
    ...
    public function save(CustomerService $customerService): void
    {
        ...
        $customerService->update($this->customer, $validated);

        session()->flash('success', 'El cliente ha sido actualizado con éxito.');
...
<div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-blue-900 dark:text-white">Editar Cliente</h1>
        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Modifica la información tributaria, ubicación, contacto o estado comercial de un cliente previamente registrado.
        </p>
    </div>
