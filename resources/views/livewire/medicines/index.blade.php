    ...
    public function with(): array
    {
        ...
        return [
            ...
            'selectedMedicine' => $this->selectedMedicineId
                ? Medicine::withTrashed()->with(['category', 'laboratory', 'sanitaryRegistry', 'container', 'contentUnit', 'barcodes', 'lots'])->find($this->selectedMedicineId)
                : null,
        ];
    }
}; ?>
    ...
    <x-modal name="medicine-detail-modal" focusable>
        @if($selectedMedicine)
            <div class="p-6">
                ...
                <!-- Audit info -->
                <div class="mt-6 border-t border-slate-100 dark:border-slate-800 pt-4 flex flex-col sm:flex-row justify-between text-[11px] text-slate-400 gap-2">
