...
new #[Layout('layouts.app')] class extends Component {
    ...
    {
        return (new StoreLaboratoryRequest())->rules();
    }
    ...
    {
        return (new StoreLaboratoryRequest())->messages();
    }

    /**
     * Create the laboratory and reset the form.
     */
    public function save(LaboratoryService $laboratoryService): void
    {
        $validated = $this->validate();

        $laboratoryService->create($validated);

        session()->flash('success', 'El laboratorio ha sido registrado con éxito.');
...
<div class="max-w-2xl mx-auto py-8">
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-blue-900 dark:text-white">Nuevo Laboratorio</h1>
        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Registra un nuevo laboratorio fabricante de medicamentos para asegurar la trazabilidad y procedencia legal en el inventario.
        </p>
    </div>
