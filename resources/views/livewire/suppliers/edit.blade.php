...
new #[Layout('layouts.app')] class extends Component
{
    ...
    /**
     * Initialize the component with supplier data.
     */
    public function mount(Supplier $supplier): void
    {
        $this->supplier = $supplier;
        $this->nit = $supplier->nit;
        $this->dv = (string) $supplier->dv;
    ...
    {
        return (new UpdateSupplierRequest)->rules($this->supplier->id);
    }
    ...
    {
        return (new UpdateSupplierRequest)->messages();
    }
    ...
    public function save(SupplierService $supplierService): void
    {
        ...
        $supplierService->update($this->supplier, $validated);

        session()->flash('success', 'El proveedor ha sido actualizado con éxito.');
...
<div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <!-- Title -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-blue-900 dark:text-white">Editar Proveedor</h1>
        <p class="text-sm text-slate-600 dark:text-slate-400 mt-1">
            Modifica la información del proveedor previamente registrado en el sistema.
        </p>
    </div>
